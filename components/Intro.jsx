  ...
  return (
    <section className="intro" id="intro">
      <div className="wrap">
        ...
        <div className="intro-grid" style={{ gridTemplateColumns: '1.4fr 1fr', alignItems: 'flex-start' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
            ...
            />
            <div className="intro-figures" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1px' }}>
          ...
          <div className="intro-copy" style={{ paddingLeft: '30px' }}>
