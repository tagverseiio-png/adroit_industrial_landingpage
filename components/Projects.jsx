      ...
      <div className="wrap">
        ...
        <div className="proj-grid">
          <div className="proj-card">
            ...
            <div className="proj-info"><h4>Auto Component Plant, 65,000 sq.ft.</h4><p>PEB Shed &middot; Civil &middot; MEP</p></div>
          </div>
          <div className="proj-card">
            <div className="proj-thumb" style={{ position: 'relative', overflow: 'hidden' }}>
            ...
            <div className="proj-info"><h4>Logistics &amp; Distribution Warehouse</h4><p>Civil &middot; PEB &middot; Fire Protection</p></div>
          </div>
          <div className="proj-card">
            <div className="proj-thumb" style={{ position: 'relative', overflow: 'hidden' }}>
            ...
            <div className="proj-info"><h4>Pharma Process Facility</h4><p>MEP &middot; HVAC &middot; PMC</p></div>
          </div>
          <div className="proj-card">
            <div className="proj-thumb" style={{ position: 'relative', overflow: 'hidden' }}>
            ...
            <div className="proj-info"><h4>FMCG Manufacturing Unit</h4><p>Architecture &middot; Civil &middot; MEP</p></div>
          </div>
          <div className="proj-card">
            <div className="proj-thumb" style={{ position: 'relative', overflow: 'hidden' }}>
              <img src="/utility_substation_new.png" alt="Utility & Substation Building" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
              <span className="tag" style={{ position: 'relative', zIndex: 1 }}>Utility Block</span>
            </div>
            <div className="proj-info"><h4>Utility &amp; Substation Building</h4><p>Civil &middot; Electrical &middot; HVAC</p></div>
          </div>
          <div className="proj-card">
            <div className="proj-thumb" style={{ position: 'relative', overflow: 'hidden' }}>
            ...
            <div className="proj-info"><h4>Cold Storage &amp; Specialized Facility</h4><p>PEB &middot; HVAC &middot; FPS &middot; PMC</p></div>
          </div>
        </div>
      </div>
